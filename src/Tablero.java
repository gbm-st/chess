public class Tablero {
    ...
    private String[] ejeX = {"( A )", "( B )", "( C )", "( D )",
            "( E )", "( F )", "( G )", "( H )"};
    //Variable para la leyenda del eje Y
    private String[] ejeY = {"8", "7", "6", "5", "4", "3", "2", "1"};
    ...
    public void inicializarTablero(){
        ...
        //Piezas de la fila 2
        for(int x = 0; x < dim; x++) piezas[6][x] = new Peon();

        //Piezas de la fila 1
        piezas[7][0] = new Torre();
        piezas[7][1] = new Caballo();
        piezas[7][2] = new Alfil();
        piezas[7][3] = new Reina();
        piezas[7][4] = new Rey();
        piezas[7][5] = new Alfil();
        piezas[7][6] = new Caballo();
        piezas[7][7] = new Torre();
    }
}